...
public class NotificationController {
	...
	public ResponseEntity<Response<Page<UserNotification>>> getNotificationsByUser(HttpServletRequest request,@PathVariable("page") Integer page, @PathVariable("count") Integer count)
	{
