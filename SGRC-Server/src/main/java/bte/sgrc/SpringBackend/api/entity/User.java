...
public class User{
	...
	@Getter @Setter @NotBlank(message = "Password required") @Min(6) @Max(60) private  String password;
	@Getter @Setter private  ProfileEnum profile;
	@Getter @Setter private  Boolean isActive = false;
	@Getter @Setter @Transient @DBRef(lazy = true) List<Notification> notifications;
	@Getter @Setter private  Boolean isDue = false;
	@Getter @Setter private  Boolean feedbackDue = false;
